...
def reorder(myPoints):
    ...
    add=myPoints.sum(1)#row wise sum
...
def getWarp(img,biggest):
    ...
    pts2 = np.float32([[0,0],[widthImg,0],[0,heightImg],[widthImg,heightImg]])#TRCIK OF REORDER
    matrix = cv2.getPerspectiveTransform(pts1,pts2)
    imgOutput = cv2.warpPerspective(img,matrix,(widthImg,heightImg))
    imgCropped=imgOutput[20:imgOutput[0]-20,20:imgOutput[1]-20]
